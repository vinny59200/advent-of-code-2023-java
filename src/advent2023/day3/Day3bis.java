...
public class Day3bis {
    ...
    static char[][] puzzle = stringToCharArray(miniSample);
    ...
    public static boolean isSymbol( char c ) {
        // Use the helper method isDigit to check if the character is a digit
        // Use the logical operator ! to negate the result
        // Use the relational operator != to check if the character is not equal to '.'
