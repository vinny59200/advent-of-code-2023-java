...
public class Day1Part2Plus {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        for ( String line : lines ) {
            ...
            String firstDigit = findFirstCalibrationDigit( line );
            System.out.println( "firstdigit: " + firstDigit );
            String lastDigit = findLastCalibrationDigit( line );
            System.out.println( "lastdigit: " + lastDigit );

            int num = Integer.parseInt( "" + stringToInt( firstDigit ) + stringToInt( lastDigit ) );
    ...
    public static String findLastCalibrationDigit( String s ) {
        int maxValueLettersDigit = Collections.max( getLettersDigitPositionMap( s ).values() );
        String resultForLetterDigits = getLettersDigitFromMap( getLettersDigitPositionMap( s ), maxValueLettersDigit );
    ...
    private static Map<String, Integer> getLettersDigitPositionMap( String s ) {
        Map<String, Integer> lettersDigitPositionMap = new TreeMap<>();
        for ( String word : WORDS ) {
            lettersDigitPositionMap.put( word, s.lastIndexOf( word ) );
        }
        return lettersDigitPositionMap;
    }

    private static String getLettersDigitFromMap( Map<String, Integer> lettersDigitPositionMap, int lettersDigitPosition ) {
