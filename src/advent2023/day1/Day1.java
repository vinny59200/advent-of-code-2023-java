...
public class Day1 {
    ...
    public static void main( String[] args ) {
        ...
        for (String line : lines) { // loop through each line
            ...
            String firstDigit = findFirstDigit(line); // get the first character of the line
            String lastDigit = findLastDigit(line); // get the last character of the line
            // concatenate it
            String concat = "" + firstDigit + lastDigit; // concatenate the two characters as a string
